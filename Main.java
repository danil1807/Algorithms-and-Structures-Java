...
Подскажите пожалуйста мне статью или книгу для того, чтобы изначально выстраивать структуру программы
максимально понятно и структурированно. Моя вечная проблема, что я начинаю писать код где попало, 
а потом, во-первых, сложно ориентироваться, во-вторых стыдно показывать остальным, а переписывать и ковыряться в нем уже лень. 

Или, может, вы в начале своего пути тоже сталкивались с подобной проблемой? Может, у вас есть пара советов?
*/
